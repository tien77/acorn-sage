        ...
        <div class="w-full bg-blue-900 pt-16 pb-24 text-center">
            ...
            <div class="flex items-center justify-center mt-8">
                ...
                " class="text-gray-800 px-4 py-2 rounded-tl-lg rounded-bl-lg bg-gray-200"
                    :class=" billingType === 'month' ? 'bg-blue-300' : 'bg-gray-200' " title="Choose Monthly billing">
                    Monthly billing
                </button>
                <button @click="
                    billingType = 'year',
                ...
                " class="text-gray-800 px-4 py-2 rounded-tr-lg rounded-br-lg bg-gray-200"
                    :class=" billingType === 'year' ? 'bg-blue-300' : 'bg-gray-200' " title="Choose Annual billing">
                    Annual billing
                </button>
            </div>
        </div>
