  ...
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="flex space-x-1 py-4 overflow-x-auto">
      ...
      @foreach($categories as $category)
        <button 
          class="filter-btn px-4 py-2 rounded-lg text-sm font-medium transition-colors duration-200 whitespace-nowrap text-gray-600 hover:text-blue-600 hover:bg-blue-50"
...
<div class="py-8 bg-gray-50 min-h-screen">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div id="loading" class="hidden text-center py-12">
      <div class="inline-flex items-center px-4 py-2 font-semibold leading-6 text-sm shadow rounded-md text-white bg-blue-600">
          ...
          <div class="relative overflow-hidden rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300 bg-white">
            ...
            <div class="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300">
              <div class="absolute bottom-0 left-0 right-0 p-4 text-white">
                ...
                <p class="text-xs text-gray-200">{{ $image['description'] }}</p>
              </div>
            </div>
    ...
    <div id="no-results" class="hidden text-center py-12">
      ...
      <h3 class="text-lg font-medium text-gray-900 mb-2">Không tìm thấy hình ảnh</h3>
      <p class="text-gray-500">Thử chọn category khác để xem thêm hình ảnh.</p>
    </div>
  </div>
</div>
  ...
  <div class="flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
    ...
    <div class="relative inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-4xl sm:w-full z-10">
      ...
      <div class="px-4 pb-4 sm:px-6 sm:pb-6">
        ...
        <div>
          <h4 id="modal-image-title" class="text-xl font-semibold text-gray-900 mb-2"></h4>
...
function initializeGallery() {
  ...
  function handleFilterClick(e) {
    ...
    button.classList.remove('text-gray-600', 'hover:text-blue-600', 'hover:bg-blue-50');
